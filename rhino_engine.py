...
class RhinoDemo(Thread):
    ...
    def run(self):
         ...
         ****** Right now, I am using the demo context path which is about a coffee machine and different things you can order. I'm trying to get 
         it to work with the demo context path because we only get a certain number of free context path's so I don't want to waste anymore******
         """
...
def main():
    ...
    parser.add_argument('--context_path', help="Absolute path to context file.", required=False,default="/Users/xuan-huongnguyen/Desktop/Team8/MagicMirror/modules/MMM-PythonPrint/engine_training/demo.rhn")
